...
INSERT INTO ARTICLES_VENDUS(nom_article,description,date_debut_encheres,date_fin_encheres,prix_initial,prix_vente,no_utilisateur,no_categorie,vignette) VALUES
	...
	('Talon Haut','Pour les gens qui aiment marcher sur la pointe des pieds tout en faisant du bruit','2020/04/06','2020/04/10',2000,20000000,3,3,'./assets/talon_haut.jpg'),
	('Ballon de foot','Zidane a joue avec quand il etait gosse','2020/04/06','2020/04/10',50,60,4,4,'./assets/zidane.jpg'),
	('Raquette de tennis','Une raquette magique qui permet de gagner tous les matchs','2020/04/06','2020/04/10',10,450,4,4,'./assets/raquette.jpg');
